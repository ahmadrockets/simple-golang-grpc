...
type UserServiceClient interface {
	GetAllUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserList, error)
...
func (c *userServiceClient) GetAllUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserList, error) {
...
type UserServiceServer interface {
	GetAllUser(context.Context, *emptypb.Empty) (*UserList, error)
...
func (UnimplementedUserServiceServer) GetAllUser(context.Context, *emptypb.Empty) (*UserList, error) {
