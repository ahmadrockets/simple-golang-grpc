...
var file_model_user_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x2c, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x4c,
	...
	0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0x6b, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73,
	...
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x24, 0x0a, 0x08,
...
var file_model_user_proto_depIdxs = []int32{
	...
	2, // 1: user.UserService.GetAllUser:input_type -> google.protobuf.Empty
	0, // 2: user.UserService.Register:input_type -> user.User
	1, // 3: user.UserService.GetAllUser:output_type -> user.UserList
	0, // 4: user.UserService.Register:output_type -> user.User
...
func file_model_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_model_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_model_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
